...
# frequency: hay que poner la cantidad periodo en un a�o, ie, si se busca
# una frecuencia de 30 min => 60*24/30*365. Por otro lado al denotar
# start tendr�amos que estarle pasando el numero del intervalo en 
# el a�o. Por ejemplo, el intervalo de 00:30 del 2 de enero 2019 ser�a
# c(2019, 50) ya que un d�a tiene 48 intervalos de 30 min
