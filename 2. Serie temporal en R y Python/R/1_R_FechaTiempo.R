...
### Opciones estándar en R base POSIXt: Portable Operating System Interface for Time (codificacián estándar)
...
50 * 365 - 5 # Numero de d�as desde 01-01-1970 (no considera los a�os bisiestos)

### Otra forma: librer�a chron
...
b = strptime(a, format = "%Y-%m-%d %H:%M") #format nos dice c�mo se debe interpretar el texto
...
## Tambi�n se puede calcular el d�a de la semana que corresponde a nuestra fecha
...
# Podemos ver en otra zona a qu� fecha y hora corresponde
